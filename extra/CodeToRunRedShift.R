...
# outputFolder <- "d:/LegendT2dmOutput_ccae1" # DONE
...
outputFolder <- "d:/LegendT2dmOutput_optum_ehr1" # DONE
...
# outputFolder <- "d:/LegendT2dmOutput_mdcr1" # DONE
...
# outputFolder <- "d:/LegendT2dmOutput_mdcd1" # DONE
...
# outputFolder <- "d:/LegendT2dmOutput_optum_dod1" # DONE
