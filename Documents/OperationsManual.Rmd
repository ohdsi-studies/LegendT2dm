...
For this latter task, we recommend using the cross-platform `keyring` `R` package to securely store: `legendt2dmServer`, `legendt2dmDatabase`, `legendt2dmUser` and `legendt2dmPassword` and specifying connection details via:
