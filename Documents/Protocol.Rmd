...
* Evaluate additional outcomes from `LEGEND-HTN` and `PhenotypeLibrary` [here](#addition-outcomes)
* New citations:
  - Recent one in Medicare: [@patorno2021comparative]
  - In VA population: [@xie2020comparative]
  - New networks meta-analysis in BMJ: [@palmer2021sodium]
  - Others: [@qiu2021comparative] [@yamada2021cardiovascular]
