...
* Add negative control list (and change language slightly)
* Limited PS model
...
A majority of outcome definitions have been previously implemented and validated in our own work [@Suchard2019-gq; @You_undated-fz; @Ryan2018-ci; @Wang2017-su; @Weinstein2020-ic; @Yuan2018-am] based heavily on prior development by others (see references in Table \@ref(tab:outcome-table)).
...
outcomes <- read.csv(system.file("settings/OutcomesOfInterest.csv",
                                 package = "LegendT2dm")) %>%
  select(atlasName,description,cite)
...
tab <- kable(negative_controls, booktabs = TRUE, linesep = "",
